...
// Тест справочника: проверяет, что OpenCode выдает ожидаемый JSON формат для инструментов todowrite и todoread
...
// Тест совместимости: проверяет, что Agent-cli выдает JSON идентичный OpenCode для todowrite и todoread
