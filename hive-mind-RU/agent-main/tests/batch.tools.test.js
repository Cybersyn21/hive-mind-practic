...
// Тест справочника (пропущен): проверяет, что OpenCode выдает ожидаемый JSON формат для инструмента batch
...
// Тест: проверяет, что Agent-cli инструмент batch выдает корректный JSON вывод
