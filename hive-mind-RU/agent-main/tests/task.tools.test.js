...
// Тест справочника: проверяет, что OpenCode выдает ожидаемый JSON формат для инструмента task
...
// Тест совместимости: проверяет, что Agent-cli выдает JSON идентичный OpenCode для инструмента task
