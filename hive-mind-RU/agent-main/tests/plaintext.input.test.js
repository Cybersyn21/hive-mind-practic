...
// Тест: проверяет, что Agent-cli принимает простой текст и преобразует его в сообщение
...
// Тест: проверяет, что Agent-cli по-прежнему принимает JSON входные данные
...
// Тест справочника: проверяет, как OpenCode обрабатывает простой текстовый ввод для сравнения
