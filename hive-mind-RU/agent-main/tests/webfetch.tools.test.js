...
// Тест справочника: проверяет, что OpenCode выдает ожидаемый JSON формат для инструмента webfetch
...
// Тест совместимости: проверяет, что Agent-cli выдает JSON идентичный OpenCode для webfetch
