...
/**
 * Модуль обработки ошибок веток для solve.mjs
 * Предоставляет улучшенные сообщения об ошибках для сбоев checkout/создания веток
 * Обнаруживает форк-PR и предлагает правильные решения для пользователя
 */

// Импортируем интеграцию Sentry для отчетов об ошибках
import { reportError } from './sentry.lib.mjs';

// Обрабатывает ошибки checkout ветки с детальной диагностикой
// Предоставляет контекстуально-специфичные решения в зависимости от типа ошибки
