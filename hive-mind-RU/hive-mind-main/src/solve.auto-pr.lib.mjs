/**
 * Модуль функциональности автоматического создания PR для solve.mjs
 * Обрабатывает автоматическое создание draft pull request с начальными коммитами
 * Создает CLAUDE.md файл с деталями задачи и пушит начальный коммит перед запуском AI
 */

// Обрабатывает автоматическое создание Pull Request
// Создает CLAUDE.md, делает начальный коммит, пушит ветку и создает draft PR
