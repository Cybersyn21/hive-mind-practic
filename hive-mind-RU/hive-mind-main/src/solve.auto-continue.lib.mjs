...
// Модуль автоматического продолжения работы для команды solve
// Извлечен из solve.mjs для поддержания размера файлов под 1500 строк
// Обрабатывает автоматическое продолжение работы с существующими PR и ожидание сброса лимитов
