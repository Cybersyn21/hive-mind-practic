...
// Тест справочника: проверяет, что OpenCode обрабатывает JSON входные данные и выдает JSON вывод
...
// Тест: проверяет, что Agent-cli обрабатывает JSON входные данные и выдает JSON вывод
...
// Тест совместимости: проверяет, что Agent-cli выдает JSON идентичный OpenCode для базовых сообщений
...
// Тест справочника: проверяет, что OpenCode обрабатывает простой текст и выдает корректный результат
...
// Тест: проверяет, что Agent-cli обрабатывает простой текст и выдает корректный результат
